...
def chat_completion_stream_response_v2(model, messages):
    ...
    for i in range(0, STREAM_COUNT):
        ...
        yield "data: " + json.dumps({
            ...
            "choices": [{
                "index": 0,
                "delta": {"content": ret_msg(model, str(i) + merge_messages(messages))},
                "is_end": is_end,
                "need_clear_history": False,
            ...
            "tools_info": {
                ...
                "baidu_search": [
                    ...
                    },
                    {
                        ...
                        "title": (
                            "上海天气预报15天_上海天气预报15天查询,上海未来15天天 ..."
                        ),
                    },
                ],
            },
...
def eb_tokenizer():
    ...
    return json_response({
        ...
        "created": 1698655037,
        "usage": {
            "prompt_tokens": 97575 + len(prompt),  # magic number for eb tokenizer api,
            "total_tokens": 97575 + len(prompt),  # magic number for eb tokenizer api
        },
    })
    ...
    if call_times is None:
        ...
        return json_response({
            ...
            "result": {
                ...
                "trainMode": "SFT",
                "peftType": "LoRA",
                "trainStatus": "FINISH" if call_times >= MAX_CALL_TIMES else "RUNNING",
                            ...
                            "items": {
                                ...
                                "properties": {
                                    "role": {
                                        ...
                                        "default": "user",
                                        "description": (
                                            '当前支持以下两个role： "user": 用户 "assistant": 对话助手'
                                        ),
                                    },
                                    "content": {
                                        "name": "content",
                ...
                "modelVersionList": [
                    {
                        ...
                        "trainType": "",
                        "description": (
                            "2024年4月19日发布版本，优化模型效果，支持128K上下文长度"
                        ),
                    },
                    {
...
def get_service():
    ...
    return json_response({
        ...
        "result": {
            ...
            "uri": "xbiimimv_xxx",
            "fullUri": (
                "http://gzns-inf-h22-for-idl28.gzns:8192/rpc/v1/agile/chat/xbiimimv_xxx"
            ),
            "applyStatus": 2,
            "serviceStatus": "Done",
            "sourceType": 1,
...
def prompt_detail():
    return json_response({
        ...
        "result": {
            ...
            "content": "请以{number}字数生成{province}省相关简介\naaa(eee) bbbb5275",
    ...
    return json_response({
        ...
        "meta_info": {
            ...
            "action_input": [
                ...
                "个人。\n\n深度合成服务使用者，是指使用深度合成服务制作、复制、发布、"
                "传播信息的组织、个人。\n\n训练数据，"
                "是指被用于训练机器学习模型的标注或者基准数据集。\n\n沉浸式拟真场景，"
                "是指应用深度合成技术生成或者编辑的、可供参与者体验或者互动的、"
                "具有高度真实感的虚拟场景。\n- 第十条"
                ...
                "限制功能、暂停服务、关闭账号等处置措施。\n\n第十一条"
                " 深度合成服务提供者应当建立健全辟谣机制，发现利用深度合成服务制作、"
                "复制、发布、传播虚假信息的，应当及时采取辟谣措施，保存有关记录，"
                "并向网信部门和有关主管部门报告。\n\n第十二条"
                " 深度合成服务提供者应当设置便捷的用户申诉和公众投诉、举报入口，"
                "公布处理流程和反馈时限，及时受理、处理和反馈处理结果。\n-"
                " （一）生成或者编辑人脸、"
                "人声等生物识别信息的；\n\n（二）生成或者编辑可能涉及国家安全、"
                "国家形象、国家利益和社会公共利益的特殊物体、场景等非生物识别信息的。"
                "\n\n第十六条 深度合成服务提供者对使用其服务生成或者编辑的信息内容，"
                ...
                "消除隐患。\n\n第二十二条 深度合成服务提供者和技术支持者违反本规定的，"
                "依照有关法律、行政法规的规定处罚；造成严重后果的，依法从重处罚。"
                "\n\n构成违反治安管理行为的，"
