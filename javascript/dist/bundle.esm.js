...
import util__default, { TextEncoder as TextEncoder$1 } from 'util';
...
var textEncoder = new TextEncoder$1();
var CRLF = '\r\n';
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 40:
            ...
            _context.prev = 43;
            _context.next = 46;
            return util__default.promisify(data.getLength).call(data);
          case 46:
...
var Auth = /*#__PURE__*/function () {
  ...
  _createClass(Auth, [{
    ...
    value: function generateAuthorization(method, resource, params, headers, timestamp, expirationInSeconds, headersToSign) {
      ...
      var rawSessionKey = util$3.format('bce-auth-v1/%s/%s/%d', this.ak, now, expirationInSeconds || 1800);
      ...
      if (signedHeaders.length) {
        return util$3.format('%s/%s/%s', rawSessionKey, signedHeaders.join(';'), signature);
      }
      return util$3.format('%s//%s', rawSessionKey, signature);
    }
  }, {
    key: "normalize",
    ...
    value: function headersCanonicalization(headers, headersToSign) {
      ...
      Object.keys(headers).forEach(function (key) {
        ...
        if (/^x\-bce\-/.test(key) || headersMap[key] === true) {
          canonicalHeaders.push(util$3.format('%s:%s', normalize(key), normalize(value)));
        }
      });
