...
class CustomHandler:
    ...
    def __init__(self, name: str = None, request_handler: Callable = None, csv_suffix: str = None, color: str = 'cyan'):
    ...
    def print_stats_json(self):
        """
        print self.stats.serialize_stats() with color
    ...
    def print_stats(self, current=True):
        """print self.stats summary with color"""
    ...
    def print_percentile_stats(self):
        """print self.stats percentile with color"""
    ...
    def print_error_report(self):
        """print self.status error report with color"""
    ...
    def test_stop_listener(self, environment):
        ...
        if environment.parsed_options.logfile and log_content:
            ...
            with open(os.path.join(output_folder, f"custom{self.id}_statistics.log"), 'w') as fs:
