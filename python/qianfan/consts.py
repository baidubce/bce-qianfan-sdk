...
class Consts:
    ...
    DatasetV2CreateDatasetQueryParam: str = "CreateDataset"
    DatasetV2GetDatasetList: str = "DescribeDatasets"
    DatasetV2DeleteDatasetQueryParam: str = "DeleteDataset"
    DatasetV2CreateDatasetVersionQueryParam: str = "CreateDatasetVersion"
    DatasetV2GetDatasetVersionInfoQueryParam: str = "DescribeDatasetVersion"
    DatasetV2DeleteDatasetVersionQueryParam: str = "DeleteDatasetVersion"
    DatasetV2PublishDatasetVersionQueryParam: str = "PublishDatasetVersion"
    DatasetV2GetDatasetVersionListQueryParam: str = "DescribeDatasetVersions"
    DatasetV2CreateDatasetVersionImportTaskQueryParam: str = "CreateImportTask"
    DatasetV2GetDatasetVersionImportTaskInfoQueryParam: str = "DescribeImportTask"
    DatasetV2CreateDatasetVersionExportTaskQueryParam: str = "CreateExportTask"
    DatasetV2GetDatasetVersionExportTaskInfoQueryParam: str = "DescribeExportTask"
